 ...
 *
 * If Comparable.Person object doesn't want to have the load of having compareTo then this class would be important and
...
public class PersonComparator implements Comparator<Person>{
    ...
    public static void main(String[] args) {
        ...
        // Since Comparable.Person object implements Comparable interface thus
        // Collections.sort(persons); would work because there is a compareTo method that sort can work on.
        Collections.sort(persons, new PersonComparator());
        // If Comparable.Person obj doesn't want to bear the load of compare
        System.out.print("***************\n");
